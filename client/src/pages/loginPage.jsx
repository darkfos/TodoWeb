...
function LoginPage()  {
    return <Fragment>
        <div className="loginMenu grid grid-rows-auto gap-20 bg-todo-theme mt-[12%] w-[60%] m-[auto] rounded-lg shadow-xl pb-10">
            ...
            <div className="loginMenu__btns flex flex-row gap-20 m-[auto] mt-[-5%]">
                <button className="bg-amber-500 rounded-lg text-white font-medium p-2">Авторизоваться</button>
                <button className="bg-amber-500 rounded-lg text-white font-medium p-2">Регистрация</button>
            </div>
        </div>
    </Fragment>
}
